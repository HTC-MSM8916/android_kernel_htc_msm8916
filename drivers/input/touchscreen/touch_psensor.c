...
/**
 *	If this attribute file exists, Phone APP will turn on the screen lock during the touch proximity sensor entering Phone Call Mode.
**/
...
/* Reserved this name for app ioctl */

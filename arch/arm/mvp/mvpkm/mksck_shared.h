...
struct Mksck_Datagram {
	...
	uint32        pad:3;      /**< padding between untyped message and */
				  /**< mpn array. */
...
struct Mksck {
	...
	uint32 index;		/**< index of this socket in page */
				...
				/**< least room for one more byte so we can */
...
struct MksckPage {
	...
	AtmUInt32 refCount;	/**< page cannot be freed unless this is zero */
				/**< ... increment with mksckPageListLock */
				/**< ... decrement at any time */
				/**< ... initialized to 1 for wsp->mksckPage* */
				/**< ... pointers */
	uint32 wakeHostRecv;	/**< bitmask of sockets to be woken for read */
	...
	Mksck sockets[1];	/**< array of sockets (fill MKSCKPAGE_SIZE) */
};

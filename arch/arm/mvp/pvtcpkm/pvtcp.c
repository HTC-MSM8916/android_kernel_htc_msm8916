	...
	.ntfCenterID = {
		{
			...
			.d32[1] = 10000	/* Default, not yet reserved,	  */
					/*	resource (vmci, only).	  */
		}
	}
};
...
PvtcpCheckArgs(CommTranspInitArgs *transpArgs)
{
	...
	while (versionIndex--) {
		if (transpArgs->type ==
			...
			/*
			 * If a match, overwrite the hash with the actual
			 * version (index).
			 */

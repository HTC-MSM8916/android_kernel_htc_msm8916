...
#define PVTCP_OFF_SOCK_COMMON_FIELDS					 \
	...
	struct PvtcpSock *parent       /* Parent socket */


/* General purpose socket flags */

enum PvtcpOffPvskFlags {
	PVTCP_OFF_PVSKF_IPV6_LOOP = 0,	/* Used for IPV6 loopback morphing */
					/*	reset. */
	PVTCP_OFF_PVSKF_SHUT_RD,	/* Set to initiate socket recv */
					/*	shutdown. */
	PVTCP_OFF_PVSKF_SHUT_WR,	/* Set to initiate socket send */
					/*	shutdown. */
	PVTCP_OFF_PVSKF_TCP_NODELAY,	/* Caches the TCP_NODELAY socket */
					/*	option. */

...
#define PANEL_ID_A50_JDI_NT35521_C3      1
#define PANEL_ID_A50_JDI_NT35521      2
...
static int htc_a50_regulator_init(struct platform_device *pdev)
{
	int ret = 0;
...
static int htc_a50_regulator_deinit(struct platform_device *pdev)
{
...
void htc_a50_panel_reset(struct mdss_panel_data *pdata, int enable)
{
...
static int htc_a50_panel_power_on(struct mdss_panel_data *pdata, int enable)
{
	int ret;
...
static struct mdss_dsi_pwrctrl dsi_pwrctrl = {
	.dsi_regulator_init = htc_a50_regulator_init,
	.dsi_regulator_deinit = htc_a50_regulator_deinit,
	.dsi_power_on = htc_a50_panel_power_on,
	.dsi_panel_reset = htc_a50_panel_reset,
};

...
#define PANEL_ID_A31_BOOYI_OTM9605A 2
#define PANEL_ID_A31_SUCCESS_R61318A1 3
#define PANEL_ID_A31_BOOYI_OTM1284A 4
#define PANEL_ID_A31_TRULY_HX8394D 5
#define PANEL_ID_A31_TIANMA_HX8394D 6
...
void htc_a31_panel_reset(struct mdss_panel_data *pdata, int enable)
{
	...
	if (enable) {
		...
		if (pdata->panel_info.panel_id == PANEL_ID_A31_SUCCESS_ILI9807 ||
			pdata->panel_info.panel_id == PANEL_ID_A31_BOOYI_OTM9605A ||
			pdata->panel_info.panel_id == PANEL_ID_A31_SUCCESS_R61318A1 ||
			pdata->panel_info.panel_id == PANEL_ID_A31_BOOYI_OTM1284A ||
			pdata->panel_info.panel_id == PANEL_ID_A31_TRULY_HX8394D ||
			pdata->panel_info.panel_id == PANEL_ID_A31_TIANMA_HX8394D) {
...
static void htc_a31_bkl_en(struct mdss_panel_data *pdata, int enable)
{
	static int en = 0;
